...
public class LocationListAddViewModel extends AndroidViewModel {
    ...
    public LocationListAddViewModel(@NonNull Application application) {
        super(application);
    ...
    public void addLocation(final int zipcode, final String jwt) {
    ...
    public void addLocationCoords(final float lat, final float lon, final String jwt) {
        String url = getApplication().getResources().getString(R.string.base_url) +
                "location/" + lat + "/" + lon;
