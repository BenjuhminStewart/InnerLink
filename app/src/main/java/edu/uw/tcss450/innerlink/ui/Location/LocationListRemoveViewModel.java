...
public class LocationListRemoveViewModel extends AndroidViewModel {
    private final MutableLiveData<JSONObject> mResponse;

    public LocationListRemoveViewModel(@NonNull Application application) {
        super(application);
    ...
    public void removeLocation(final int primaryKey, final String jwt) {
